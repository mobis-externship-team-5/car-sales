...
int ui_product_detail(char *switch_value, int *user_role);
int ui_purchase();
...
int ui_login(char *switch_value, int *user_role)
{
    ...
    default:
        printf("SELECT ALRIGHT MENU NUMBER\n");
	*switch_value = '1';
...
int ui_main_window(char *switch_value, int *user_role)
{
    ...
    while (1)
    {
        ...
        else if (switch_value_main == '9' && *user_role != 0)
        {
            system("clear");
            *switch_value = '1'; //로그아웃
            break;
		...
		system("clear");
            ...
            case '3': // detail
                system("clear");
                ui_product_detail(&switch_value_main,user_role);
		...
		system("clear");
            ...
            {
            case '1': // search
                system("clear");// ui_product_search(PRODUCT *phead, PRODUCT **shead, PRODUCT **stail);
                ui_product_search(&switch_value_main,user_role); //�뜝�럥�뿰�뼨轅명�ｉ뇡�쉻�삕�굢占� scanf
                break;
            case '2': // sort
                system("clear");
...
int ui_product_search(char *switch_value, int *user_role)
{
    ...
    while (1)
    {
        ...
        else if (switch_value_search == '9' && *user_role !=0)
        {
            system("clear");
            *switch_value = '9';
            break;
...
int ui_product_detail(char *switch_value, int *user_role)
{
    ...
    while (1)
    {
        ...
        else if (switch_value_detail == '9' && *user_role != 0)
        {
            system("clear");
            *switch_value = '9';
            break;
...
int ui_order_list(char *switch_value, int *user_role)
{
    ...
    while (1)
    {
        ...
        ui_basic_form_top("MYPAGE_ADMIN_ORDERLIST");
        ...
        case '3': // detail
            system("clear");
            ui_product_detail(&switch_value_order,user_role);
            // ui_product_detail(PRODUCT *phead, PRODUCT_DETAIL *dhead, int product_id);
            break;
        case '4': // previous
            // set nouser role
...
int ui_stock_list(char *switch_value, int *user_role)
{
    ...
    while (1)
    {
        ...
        case '2': // sort
            ...
            break;
        case '3': // detail
            ui_product_detail(&switch_value_stock,user_role);
            // ui_product_detail(PRODUCT *phead, PRODUCT_DETAIL *dhead, int product_id);
            break;
        case '4': // previous
            printf("previous\n");
